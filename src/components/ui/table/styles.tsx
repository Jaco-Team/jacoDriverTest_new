...
export const tableHeadStyle = tva({
  ...
  base: 'px-6 py-[14px] text-left font-bold text-[16px] leading-[22px] text-typography-800 font-roboto',
});
...
export const tableDataStyle = tva({
  ...
  base: 'px-6 py-[14px] text-left text-[16px] font-medium leading-[22px] text-typography-800 font-roboto',
});
